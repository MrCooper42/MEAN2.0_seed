...
export class View_ProfileComponent0 extends import1.AppView<import0.ProfileComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_0_0_0:any = this.context.loggedIn();
  ...
  createEmbeddedViewInternal(nodeIndex:number):import1.AppView<any> {
    if ((nodeIndex == 0)) { return new View_ProfileComponent1(this.viewUtils,this,0,this._anchor_0,this._vc_0); }
    return (null as any);
  }
}
class View_ProfileComponent1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._text_24 = this.renderer.createText(this._el_23,'Summary',(null as any));
