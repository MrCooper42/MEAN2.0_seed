...
class MdProgressCircleModuleInjector extends import0.NgModuleInjector {
    constructor(parent) {
        super(parent, [], []);
    }
...
export const MdProgressCircleModuleNgFactory = new import0.NgModuleFactory(MdProgressCircleModuleInjector, import1.MdProgressCircleModule);
export class Wrapper_MdProgressCircle {
    ...
    checkHost(view, componentView, el, throwOnChange) {
        const currVal_2 = this.context._ariaValueMin;
        ...
        const currVal_3 = this.context._ariaValueMax;
        ...
        const currVal_4 = this.context.value;
        ...
        const currVal_5 = this.context.mode;
...
class View_MdProgressCircle_Host0 extends import5.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement) {
        super(View_MdProgressCircle_Host0, renderType_MdProgressCircle_Host, import9.ViewType.HOST, viewUtils, parentView, parentIndex, parentElement, import4.ChangeDetectorStatus.CheckAlways);
    }
...
export const MdProgressCircleNgFactory = new import10.ComponentFactory('md-progress-circle, mat-progress-circle', View_MdProgressCircle_Host0, import1.MdProgressCircle);
const styles_MdProgressCircle = [import13.styles];
...
export class View_MdProgressCircle0 extends import5.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement) {
        super(View_MdProgressCircle0, renderType_MdProgressCircle, import9.ViewType.COMPONENT, viewUtils, parentView, parentIndex, parentElement, import4.ChangeDetectorStatus.CheckOnce);
    }
    createInternal(rootSelector) {
...
class View_MdSpinner_Host0 extends import5.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement) {
        super(View_MdSpinner_Host0, renderType_MdSpinner_Host, import9.ViewType.HOST, viewUtils, parentView, parentIndex, parentElement, import4.ChangeDetectorStatus.CheckAlways);
    }
    createInternal(rootSelector) {
...
export const MdSpinnerNgFactory = new import10.ComponentFactory('md-spinner, mat-spinner', View_MdSpinner_Host0, import1.MdSpinner);
const styles_MdSpinner = [import13.styles];
var renderType_MdSpinner = import6.createRenderComponentType('', 0, import8.ViewEncapsulation.Emulated, styles_MdSpinner, {});
export class View_MdSpinner0 extends import5.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement) {
        super(View_MdSpinner0, renderType_MdSpinner, import9.ViewType.COMPONENT, viewUtils, parentView, parentIndex, parentElement, import4.ChangeDetectorStatus.CheckAlways);
    }
    createInternal(rootSelector) {
        const parentRenderNode = this.renderer.createViewRoot(this.parentElement);
        this._text_0 = this.renderer.createText(parentRenderNode, '\n', null);
