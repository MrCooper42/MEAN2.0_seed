...
class View_MdMenu_Host0 extends import2.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement) {
        super(View_MdMenu_Host0, renderType_MdMenu_Host, import7.ViewType.HOST, viewUtils, parentView, parentIndex, parentElement, import1.ChangeDetectorStatus.CheckAlways);
    }
...
export const MdMenuNgFactory = new import8.ComponentFactory('md-menu, mat-menu', View_MdMenu_Host0, import0.MdMenu);
const styles_MdMenu = [import9.styles];
...
export class View_MdMenu0 extends import2.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement) {
        super(View_MdMenu0, renderType_MdMenu, import7.ViewType.COMPONENT, viewUtils, parentView, parentIndex, parentElement, import1.ChangeDetectorStatus.CheckAlways);
    }
    createInternal(rootSelector) {
...
class View_MdMenu1 extends import2.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement, declaredViewContainer) {
        super(View_MdMenu1, renderType_MdMenu, import7.ViewType.EMBEDDED, viewUtils, parentView, parentIndex, parentElement, import1.ChangeDetectorStatus.CheckAlways, declaredViewContainer);
    ...
    detectChangesInternal(throwOnChange) {
        ...
        const currVal_1_0_0 = 'md-menu-panel';
        this._NgClass_1_3.check_klass(currVal_1_0_0, throwOnChange, false);
        const currVal_1_0_1 = this.parentView.context._classList;
